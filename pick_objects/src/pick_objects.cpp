...
void send_goal_to_move_base(MoveBaseClient & ac, double x, double y, double orient)
{
  ...
  ROS_INFO("Robot is travelling to the destination.."); 
...
int main(int argc, char** argv){
    ...
    double pick_up_position[2]  = {-1.0, -3.0};
    double drop_off_position[2] = {-0.5, 0.5};
    ...
    // Pause for 5 seconds at pick up zone
    sleep(5); 
